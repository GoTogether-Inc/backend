...
public enum ErrorStatus implements BaseErrorCode {
	...
	_HOST_CHANNEL_DELETE_FAILED_MEMBERS_EXIST(HttpStatus.BAD_REQUEST, "HOST_CHANNEL4002",
		"멤버가 아직 존재하여, 호스트 채널을 삭제할 수 없습니다."),
	...
	_HOST_CHANNEL_DELETE_FAILED_EVENTS_EXIST(HttpStatus.BAD_REQUEST, "HOST_CHANNEL4005",
		"이벤트가 아직 존재하여, 호스트 채널을 삭제할 수 없습니다."),
	...
	_TICKET_OPTION_ANSWER_ALREADY_EXISTS(HttpStatus.BAD_REQUEST, "TICKET_OPTION_ANSWER4002",
		"해당 티켓 옵션에 대한 응답이 이미 존재합니다."),
