...
public class HostChannelControllerTest {
	...
	@Test
	@DisplayName("호스트 채널 생성 성공")
	void testCreateHostChannel_success() throws Exception {
		// GIVEN
	...
	@Test
	@DisplayName("호스트 채널 상세 조회 성공")
	void testGetDetailHostChannel_success() throws Exception {
		// GIVEN
	...
	@Test
	@DisplayName("호스트 채널 수정 성공")
	void testUpdateHostChannel_success() throws Exception {
		// GIVEN
		HostChannelRequestDTO request = HostChannelRequestDTO.builder()
	...
	@Test
	@DisplayName("호스트 채널 삭제 성공")
	void testDeleteHostChannel_success() throws Exception {
		// GIVEN
	...
	@Test
	@DisplayName("호스트 채널 목록 조회 성공")
	void testGetHostChannelsByUser_success() throws Exception {
		// GIVEN
		HostChannelListResponseDTO responseDTO = HostChannelListResponseDTO.builder()
			.id(1L)
			.profileImageUrl("http://example.com/profile.jpg")
			.hostChannelName("Test Channel")
			.build();
	...
	@Test
	@DisplayName("호스트 채널 정보 조회 성공")
	void testGetHostChannelInfo_success() throws Exception {
		// GIVEN
		HostChannelInfoResponseDTO responseDTO = HostChannelInfoResponseDTO.builder()
			.id(1L)
			.profileImageUrl("http://example.com/profile.jpg")
			.hostChannelName("Test Channel")
			.channelDescription("This is a test channel")
	...
	@Test
	@DisplayName("호스트 채널 검색 성공")
	void testGetHostChannelsSearch_success() throws Exception {
		// GIVEN
		HostChannelListResponseDTO responseDTO = HostChannelListResponseDTO.builder()
			.id(1L)
			.profileImageUrl("http://example.com/profile.jpg")
	...
	@Test
	@DisplayName("호스트 대시보드 조회 성공")
	void testGetHostDashboard_success() throws Exception {
		// GIVEN
		HostDashboardResponseDTO responseDTO = HostDashboardResponseDTO.builder()
	...
	@Test
	@DisplayName("참가자 관리 조회 성공")
	void testGetParticipantManagement_success() throws Exception {
		// GIVEN
		ParticipantManagementResponseDTO responseDTO = ParticipantManagementResponseDTO.builder()
			.id(1L)
			.orderNumber(1L)
	...
	void testApproveOrderStatus_success() throws Exception {
		// GIVEN
